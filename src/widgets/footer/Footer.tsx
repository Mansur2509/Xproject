        ...
        <div className="footer-grid">
          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <div className="logo-badge" style={{ width: '42px', height: '42px' }} aria-hidden="true">
              <svg viewBox="0 0 64 64" role="img" aria-label="XProject logo small">
                <defs>
            ...
            <div>
              <b style={{ color: 'var(--navy)', fontWeight: 900 }}>XProjectUZ</b>
              <div className="foot-note">
                Образовательная платформа и комьюнити: дебаты, MUN, тренинги и подготовка к экзаменам.
                <br />© {currentYear} XProjectUZ. Все права защищены.
              </div>
            </div>
          </div>
